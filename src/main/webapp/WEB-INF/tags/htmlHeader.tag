...
<%--
Smartboard :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>Smartboard :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/Smartboard.css" var="SmartboardCss"/>
    <link href="${SmartboardCss}" rel="stylesheet"/>
