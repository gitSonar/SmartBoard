    ...
    <jsp:body>
        ...
        <form:form modelAttribute="pet"
            ...
            <div class="form-group has-feedback">
                ...
                <Smartboard:inputField label="Name" name="name"/>
                <Smartboard:inputField label="Birth Date" name="birthDate"/>
                <div class="control-group">
                    <Smartboard:selectField name="type" label="Type " names="${types}" size="5"/>
                </div>
            </div>
            <div class="form-group">
